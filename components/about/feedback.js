...
export const Feedback = () => {
  return (
    <div className="mt-10 w-100 h-auto p-[8vh] text-center  bg-red-100 bg-[url('https://res.cloudinary.com/dxuxmr72e/image/upload/v1650905187/Bookstore/Banner/bannerimg_ax99iw.png')] bg-center bg-cover">
